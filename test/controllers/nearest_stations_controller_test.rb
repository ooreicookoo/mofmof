...
class NearestStationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nearest_station" do
    assert_difference('NearestStation.count') do
      post nearest_stations_url, params: { nearest_station: { min_foot: @nearest_station.min_foot, property_id: @nearest_station.property_id, route_name: @nearest_station.route_name, station: @nearest_station.station } }
    end
  ...
  test "should update nearest_station" do
    patch nearest_station_url(@nearest_station), params: { nearest_station: { min_foot: @nearest_station.min_foot, property_id: @nearest_station.property_id, route_name: @nearest_station.route_name, station: @nearest_station.station } }
